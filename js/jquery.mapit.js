	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			marker: {
				latitude: 	37.970996,
				longitude: 	23.730542,
				icon: 			'img/map/marker_creative.png',
				title: 			'Click to Know More',
				open: 			false,
				center: 		true
			},
			address: '<h2 class="ultrabold dark f-normal uppercase" style="padding: 20px;">The Elio Studio</span></h2><p class="light gray2 lato">849 Strawberry Ave. Athens, GA 30605</p>',
			styles: 'false',
			origins: [
				['37.936294', '23.947394'],
				['37.975669', '23.733868']
